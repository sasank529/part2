...
const App = () => {
  ...
  return (
    <div>
      ...
      <Filt value={newFilter} onChange={handleFilterChange} />
      <h2>Add new person</h2>
      <PeopleForm onSubmit={addPerson} newName={newName} handleNameChange={handleNameChange} newNumber={newNumber} handleNumberChange={handleNumberChange} />
      <h2>Numbers</h2>
      <Context persons={persons} allPersons={allPersons} deletePerson={deletePerson} />
    </div>
  )
}
